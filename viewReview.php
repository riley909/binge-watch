        ...
        <form action="applyComment.php" method="post" id="commentForm">
            <div class="container-fluid mt-5">
                <div class="form-group col-md-8">
                    ...
                    <textarea class="form-control" rows="5" name="commentInput" id="commentIntpu"></textarea>
                    ...
                    <div class="comments-list">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <button type="button" style="border: 0; outline:0; color:blue;" onclick="deleteComment(<?=$commentIdx?>)">삭제</button></small></p>
                                <?php }?>
                            </div>
                            <p class="pull-right">
